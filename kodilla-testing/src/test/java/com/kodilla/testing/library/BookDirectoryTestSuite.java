...
public class BookDirectoryTestSuite {
    ...
    void testList0BooksInHandsOf() {
        // Given
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        LibraryUser libraryUser = new LibraryUser("John", "Snow", "80040204455");
        List<Book> rented0Books = new ArrayList<Book>();
    ...
    void testList1BookInHandsOf() {
        ...
        // When
        List<Book> oneBook = bookLibrary.listBooksInHandsOf(libraryUser);
